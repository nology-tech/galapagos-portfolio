export const data = [
  ...
  },
  {
    ...
    technology: ['<i class="html fab fa-html5 fa-2x"></i>', '<i class="sass fab fa-sass fa-2x"></i>', '<i class="javascript fab fa-js-square fa-2x"></i>', '<i class="react fab fa-react fa-2x"></i>', '<i class="node fab fa-node fa-2x"></i>', '<li><i class="fa-li fa fa-angle-double-right"></i>Firebase</li>'],
    role: 'rolerole',
