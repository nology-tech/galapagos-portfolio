export const data = [
  ...
  },
  {
    ...
    technology: ['<i class="html fab fa-html5"></i>', '<i class="sass fab fa-sass"></i>', '<i class="javascript fab fa-js-square"></i>', '<i class="react fab fa-react"></i>', '<i class="node fab fa-node"></i>', '<li><i class="fa-li fa fa-angle-double-right"></i>Firebase</li>'],
    role: 'rolerole',
  ...
  },
  {
    ...
    technology: ['<i class="html fab fa-html5"></i>', '<i class="sass fab fa-sass"></i>'],
  ...
  },
  {
    ...
    technology: ['<i class="html fab fa-html5"></i>', '<i class="css fab fa-css"></i>'],
