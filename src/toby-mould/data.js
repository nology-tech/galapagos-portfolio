export const projects = [
  {
    ...
    technology: ['<i class="html fab fa-html5 fa-2x"></i>', '<i class="sass fab fa-sass fa-2x"></i>', '<i class="javascript fab fa-js-square fa-2x"></i>'],
  ...
  },
  {
    ...
    technology: ['<i class="html fab fa-html5 fa-2x"></i>', '<i class="sass fab fa-sass fa-2x"></i>', '<i class="javascript fab fa-js-square fa-2x"></i>', '<i class="react fab fa-react fa-2x"></i>', '<i class="node fab fa-node fa-2x"></i>', '<img class="firebase-modal" src="./img/icons/firebase.png" alt="firebase logo" />'],
  ...
  },
  {
    ...
    github: 'https://',
    overview: 'overviewoverview',
    technology: ['<i class="html fab fa-html5 fa-2x"></i>', '<i class="sass fab fa-sass fa-2x"></i>', '<i class="javascript fab fa-js-square fa-2x"></i>', '<i class="react fab fa-react fa-2x"></i>', '<i class="node fab fa-node fa-2x"></i>', '<img class="mongodb-modal" src="./img/icons/mongoDB.png" alt="MongoDB logo" />'],
  ...
  },
  {
    ...
    technology: ['<i class="html fab fa-html5 fa-2x"></i>', '<i class="sass fab fa-sass fa-2x"></i>'],
    languages: ['html', 'sass'],
  ...
  },
  {
    ...
    technology: ['<i class="html fab fa-html5 fa-2x"></i>', '<i class="css fab fa-css"></i>'],
    languages: ['html', 'css'],
